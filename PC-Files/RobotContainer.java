...
public class RobotContainer
{
  ...
  private SuperStructure superStructure = new SuperStructure(intake, elevator);
  // private Intake intake = new Intake();
...
//False, stop the motors.
operatorXbox.leftBumper()
.onFalse(
  superStructure.stopMotors());
